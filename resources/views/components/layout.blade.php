                    ...
                    <div class="relative group py-2">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <!-- Updated: Link to the Class Links hub -->
                                <a href="{{ route('class.links') }}" 
                                   class="px-4 py-2.5 text-sm {{ request()->routeIs('class.links') ? 'bg-blue-50 text-blue-700 font-bold' : 'text-gray-600' }} hover:bg-blue-50 hover:text-academic-blue transition-colors whitespace-nowrap">
                                   Class Links
                                </a>
